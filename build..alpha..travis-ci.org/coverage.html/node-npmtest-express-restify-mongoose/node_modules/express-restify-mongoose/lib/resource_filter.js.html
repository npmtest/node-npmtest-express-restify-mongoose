...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/resource_filter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/resource_filter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/</a> &#187; resource_filter.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function Filter(opts) {</span>
<span class="cstat-no" title="statement not covered" >  this.model = opts.model;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.filteredKeys = _.isPlainObject(opts.filteredKeys) ? {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.model &amp;&amp; this.model.discriminators &amp;&amp; _.isPlainObject(opts.excludedMap)) {</span>
<span class="cstat-no" title="statement not covered" >    for (var modelName in this.model.discriminators) {</span>
<span class="cstat-no" title="statement not covered" >      if (opts.excludedMap[modelName]) {</span>
<span class="cstat-no" title="statement not covered" >        this.filteredKeys.private = this.filteredKeys.private.concat(opts.excludedMap[modelName].private);</span>
<span class="cstat-no" title="statement not covered" >        this.filteredKeys.protected = this.filteredKeys.protected.concat(opts.excludedMap[modelName].protected);</span>
      }
    }
  }
}
 ...
 */
Filter.prototype.getExcluded = <span class="fstat-no" title="function not covered" >function (opts) {</span>
<span class="cstat-no" title="statement not covered" >  if (opts.access === 'private') {</span>
<span class="cstat-no" title="statement not covered" >    return [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var entry = opts.excludedMap &amp;&amp; opts.modelName ? opts.excludedMap[opts.modelName] : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!entry) {</span>
<span class="cstat-no" title="statement not covered" >    entry = _.isPlainObject(opts.filteredKeys) ? {</span>
      private: opts.filteredKeys.private || [],
      protected: opts.filteredKeys.protected || []
    } : {
      private: [],
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return opts.access === 'protected' ? entry.private : entry.private.concat(entry.protected);</span>
};
&nbsp;
Filter.prototype.isExcluded = <span class="fstat-no" title="function not covered" >function (field, opts) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getExcluded(opts).indexOf(field) &gt;= 0;</span>
};
&nbsp;
/**
 ...
 */
Filter.prototype.filterItem = <span class="fstat-no" title="function not covered" >function (item, excluded) {</span>
...
<span class="cstat-no" title="statement not covered" >    return item.map(<span class="fstat-no" title="function not covered" >function (i) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this.filterItem(i, excluded);</span>
    });
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (item &amp;&amp; excluded) {</span>
<span class="cstat-no" title="statement not covered" >    if (_.isFunction(item.toObject)) {</span>
<span class="cstat-no" title="statement not covered" >      item = item.toObject();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, length = excluded.length; i &lt; length; i++) {</span>
<span class="cstat-no" title="statement not covered" >      if (excluded[i].indexOf('.') &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        weedout(item, excluded[i]);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        delete item[excluded[i]];</span>
      }
    }
  }
&nbsp;
 ...
 * @returns {Object} - Filtered document.
 */
Filter.prototype.filterPopulatedItem = <span class="fstat-no" title="function not covered" >function (item, opts) {</span>
<span class="cstat-no" title="statement not covered" >  var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (_.isArray(item)) {</span>
<span class="cstat-no" title="statement not covered" >    return item.map(<span class="fstat-no" title="function not covered" >function (i) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this2.filterPopulatedItem(i, opts);</span>
    });
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0; i &lt; opts.populate.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    if (!opts.populate[i].path) {</span>
<span class="cstat-no" title="statement not covered" >      continue;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var excluded = this.getExcluded({</span>
      access: opts.access,
      excludedMap: opts.excludedMap,
      modelName: detective(this.model, opts.populate[i].path)
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_.has(item, opts.populate[i].path)) {</span>
<span class="cstat-no" title="statement not covered" >      this.filterItem(_.get(item, opts.populate[i].path), excluded);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      var pathToArray = opts.populate[i].path.split('.').slice(0, -1).join('.');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (_.has(item, pathToArray)) {</span>
<span class="cstat-no" title="statement not covered" >        var array = _.get(item, pathToArray);</span>
<span class="cstat-no" title="statement not covered" >        var pathToObject = opts.populate[i].path.split('.').slice(-1).join('.');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.filterItem(_.map(array, pathToObject), excluded);</span>
      }
    }
  }
&nbsp;
 ...
 * @returns {Object} - Filtered document.
 */
Filter.prototype.filterObject = <span class="fstat-no" title="function not covered" >function (resource) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var filtered = this.filterItem(resource, this.getExcluded(opts));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (opts.populate) {</span>
<span class="cstat-no" title="statement not covered" >    this.filterPopulatedItem(filtered, opts);</span>
  }
&nbsp;
