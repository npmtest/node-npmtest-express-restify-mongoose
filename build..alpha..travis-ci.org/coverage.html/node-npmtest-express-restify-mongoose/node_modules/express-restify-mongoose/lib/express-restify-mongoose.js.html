...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/express-restify-mongoose.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-express-restify-mongoose">npmtest-express-restify-mongoose (v0.0.2)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/express-restify-mongoose.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/</a> &#187; express-restify-mongoose.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return _.defaults(_.clone(customDefaults) || {}, {</span>
    prefix: '/api',
    version: '/v1',
    idProperty: '_id',
...
&nbsp;
var restify = <span class="fstat-no" title="function not covered" >function restify(app, model) {</span>
...
<span class="cstat-no" title="statement not covered" >  _.assign(options, getDefaults(), opts);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var access = require('./middleware/access');</span>
<span class="cstat-no" title="statement not covered" >  var ensureContentType = require('./middleware/ensureContentType')(options);</span>
<span class="cstat-no" title="statement not covered" >  var filterAndFindById = require('./middleware/filterAndFindById')(model, options);</span>
<span class="cstat-no" title="statement not covered" >  var onError = require('./middleware/onError');</span>
<span class="cstat-no" title="statement not covered" >  var outputFn = require('./middleware/outputFn');</span>
<span class="cstat-no" title="statement not covered" >  var prepareQuery = require('./middleware/prepareQuery')(options);</span>
<span class="cstat-no" title="statement not covered" >  var prepareOutput = require('./middleware/prepareOutput')(options, excludedMap);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.private)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('"options.private" must be an array of fields');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.protected)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('"options.protected" must be an array of fields');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  model.schema.eachPath(<span class="fstat-no" title="function not covered" >function (name, path) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (path.options.access) {</span>
<span class="cstat-no" title="statement not covered" >      switch (path.options.access.toLowerCase()) {</span>
        case 'private':
<span class="cstat-no" title="statement not covered" >          options.private.push(name);</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        case 'protected':
<span class="cstat-no" title="statement not covered" >          options.protected.push(name);</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
      }
    }
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  options.filter = new Filter({</span>
    model: model,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  excludedMap[model.modelName] = options.filter.filteredKeys;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.preMiddleware)) {</span>
<span class="cstat-no" title="statement not covered" >    options.preMiddleware = options.preMiddleware ? [options.preMiddleware] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.preCreate)) {</span>
<span class="cstat-no" title="statement not covered" >    options.preCreate = options.preCreate ? [options.preCreate] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.preRead)) {</span>
<span class="cstat-no" title="statement not covered" >    options.preRead = options.preRead ? [options.preRead] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.preUpdate)) {</span>
<span class="cstat-no" title="statement not covered" >    options.preUpdate = options.preUpdate ? [options.preUpdate] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.preDelete)) {</span>
<span class="cstat-no" title="statement not covered" >    options.preDelete = options.preDelete ? [options.preDelete] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!options.contextFilter) {</span>
<span class="cstat-no" title="statement not covered" >    options.contextFilter = <span class="fstat-no" title="function not covered" >function (model, req, done) {</span></span>
<span class="cstat-no" title="statement not covered" >      return done(model);</span>
    };
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.postCreate)) {</span>
<span class="cstat-no" title="statement not covered" >    options.postCreate = options.postCreate ? [options.postCreate] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.postRead)) {</span>
<span class="cstat-no" title="statement not covered" >    options.postRead = options.postRead ? [options.postRead] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.postUpdate)) {</span>
<span class="cstat-no" title="statement not covered" >    options.postUpdate = options.postUpdate ? [options.postUpdate] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_.isArray(options.postDelete)) {</span>
<span class="cstat-no" title="statement not covered" >    options.postDelete = options.postDelete ? [options.postDelete] : [];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!options.onError) {</span>
<span class="cstat-no" title="statement not covered" >    options.onError = onError(!options.restify);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!options.outputFn) {</span>
<span class="cstat-no" title="statement not covered" >    options.outputFn = outputFn(!options.restify);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  options.name = options.name || model.modelName;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var ops = require('./operations')(model, options, excludedMap);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var uriItem = '' + options.prefix + options.version + '/' + options.name;</span>
<span class="cstat-no" title="statement not covered" >  if (uriItem.indexOf('/:id') === -1) {</span>
<span class="cstat-no" title="statement not covered" >    uriItem += '/:id';</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var uriItems = uriItem.replace('/:id', '');</span>
<span class="cstat-no" title="statement not covered" >  var uriCount = uriItems + '/count';</span>
<span class="cstat-no" title="statement not covered" >  var uriShallow = uriItem + '/shallow';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (_.isUndefined(app.delete)) {</span>
<span class="cstat-no" title="statement not covered" >    app.delete = app.del;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    req.erm = { model: model };</span>
<span class="cstat-no" title="statement not covered" >    next();</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  var accessMiddleware = options.access ? access(options) : [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  app.get(uriItems, prepareQuery, options.preMiddleware, options.preRead, accessMiddleware, ops.getItems, prepareOutput);</span>
<span class="cstat-no" title="statement not covered" >  app.get(uriCount, prepareQuery, options.preMiddleware, options.preRead, accessMiddleware, ops.getCount, prepareOutput);</span>
<span class="cstat-no" title="statement not covered" >  app.get(uriItem, prepareQuery, options.preMiddleware, options.preRead, accessMiddleware, ops.getItem, prepareOutput);</span>
<span class="cstat-no" title="statement not covered" >  app.get(uriShallow, prepareQuery, options.preMiddleware, options.preRead, accessMiddleware, ops.getShallow, prepareOutput);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  app.post(uriItems, prepareQuery, ensureContentType, options.preMiddleware, options.preCreate, accessMiddleware, ops.createObject, prepareOutput);</span>
<span class="cstat-no" title="statement not covered" >  app.post(uriItem, util.deprecate(prepareQuery, 'express-restify-mongoose: in a future major version, the POST method to update resources will be removed. Use PATCH instead.'), ensureContentType, options.preMiddleware, options.findOneAndUpdate ? [] : filterAndFindById, options.preUpdate, accessMiddleware, ops.modifyObject, prepareOutput);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  app.put(uriItem, util.deprecate(prepareQuery, 'express-restify-mongoose: in a future major version, the PUT method will replace rather than update a resource. Use PATCH instead.'), ensureContentType, options.preMiddleware, options.findOneAndUpdate ? [] : filterAndFindById, options.preUpdate, accessMiddleware, ops.modifyObject, prepareOutput);</span>
<span class="cstat-no" title="statement not covered" >  app.patch(uriItem, prepareQuery, ensureContentType, options.preMiddleware, options.findOneAndUpdate ? [] : filterAndFindById, options.preUpdate, accessMiddleware, ops.modifyObject, prepareOutput);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  app.delete(uriItems, prepareQuery, options.preMiddleware, options.preDelete, ops.deleteItems, prepareOutput);</span>
<span class="cstat-no" title="statement not covered" >  app.delete(uriItem, prepareQuery, options.preMiddleware, options.findOneAndRemove ? [] : filterAndFindById, options.preDelete, ops.deleteItem, prepareOutput);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return uriItems;</span>
};
&nbsp;
module.exports = {
  defaults: <span class="fstat-no" title="function not covered" >function defaults(options) {</span>
<span class="cstat-no" title="statement not covered" >    customDefaults = options;</span>
  },
  serve: restify
};
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Wed Apr 19 2017 17:32:04 GMT+0000 (UTC)</div>
</div>
</body>
</html>
