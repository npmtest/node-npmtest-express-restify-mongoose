...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/errorHandler.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/errorHandler.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/</a> &#187; errorHandler.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      if (err.message === http.STATUS_CODES[404] || req.params.id &amp;&amp; err.path === options.idProperty &amp;&amp; err.name === 'CastError') {</span>
<span class="cstat-no" title="statement not covered" >        req.erm.statusCode = 404;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        req.erm.statusCode = req.erm.statusCode &amp;&amp; req.erm.statusCode &gt;= 400 ? req.erm.statusCode : 400;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      options.onError(err, req, res, next);</span>
    };
  };
};
