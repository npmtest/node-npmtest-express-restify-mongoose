...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/access.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/access.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/</a> &#187; access.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    var handler = <span class="fstat-no" title="function not covered" >function handler(err, access) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        return errorHandler(req, res, next)(err);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (['public', 'private', 'protected'].indexOf(access) &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Unsupported access, must be "private", "protected" or "public"');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      req.access = access;</span>
<span class="cstat-no" title="statement not covered" >      next();</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (options.access.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      options.access(req, handler);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      handler(null, options.access(req));</span>
    }
  };
};
