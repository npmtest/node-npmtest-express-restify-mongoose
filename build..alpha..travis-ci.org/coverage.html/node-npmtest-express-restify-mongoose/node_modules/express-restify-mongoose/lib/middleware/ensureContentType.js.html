...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/ensureContentType.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/ensureContentType.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/</a> &#187; ensureContentType.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function ensureContentType(req, res, next) {</span></span>
<span class="cstat-no" title="statement not covered" >    var ct = req.headers['content-type'];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!ct) {</span>
<span class="cstat-no" title="statement not covered" >      return errorHandler(req, res, next)(new Error('missing_content_type'));</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (ct.indexOf('application/json') === -1) {</span>
<span class="cstat-no" title="statement not covered" >      return errorHandler(req, res, next)(new Error('invalid_content_type'));</span>
    }
&nbsp;
