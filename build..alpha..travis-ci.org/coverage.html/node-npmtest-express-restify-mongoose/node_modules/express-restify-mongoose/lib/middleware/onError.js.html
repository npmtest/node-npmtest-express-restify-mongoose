...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/onError.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/onError.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/</a> &#187; onError.js</div>
</div>
<div class="body">
...
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function (isExpress) {</span>
...
<span class="cstat-no" title="statement not covered" >    var serializedErr = serializeError(err);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    delete serializedErr.stack;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (serializedErr.errors) {</span>
<span class="cstat-no" title="statement not covered" >      for (var key in serializedErr.errors) {</span>
<span class="cstat-no" title="statement not covered" >        delete serializedErr.errors[key].reason;</span>
<span class="cstat-no" title="statement not covered" >        delete serializedErr.errors[key].stack;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    res.setHeader('Content-Type', 'application/json');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isExpress) {</span>
<span class="cstat-no" title="statement not covered" >      res.status(req.erm.statusCode).send(serializedErr);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      res.send(req.erm.statusCode, serializedErr);</span>
    }
  };
};
