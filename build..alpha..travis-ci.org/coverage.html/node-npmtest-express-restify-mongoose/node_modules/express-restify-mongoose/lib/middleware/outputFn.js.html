...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/outputFn.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/outputFn.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/</a> &#187; outputFn.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function output(req, res) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        res.status(req.erm.statusCode).json(req.erm.result);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        res.sendStatus(req.erm.statusCode);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      res.send(req.erm.statusCode, req.erm.result);</span>
    }
  };
};
