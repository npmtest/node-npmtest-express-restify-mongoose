...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/prepareOutput.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/prepareOutput.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/</a> &#187; prepareOutput.js</div>
</div>
<div class="body">
...
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function (options, excludedMap) {</span>
...
<span class="cstat-no" title="statement not covered" >    var postMiddleware = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    switch (req.method.toLowerCase()) {</span>
      case 'get':
<span class="cstat-no" title="statement not covered" >        postMiddleware = options.postRead;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
      case 'post':
<span class="cstat-no" title="statement not covered" >        if (req.erm.statusCode === 201) {</span>
<span class="cstat-no" title="statement not covered" >          postMiddleware = options.postCreate;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          postMiddleware = options.postUpdate;</span>
        }
<span class="cstat-no" title="statement not covered" >        break;</span>
      case 'put':
      case 'patch':
...
<span class="cstat-no" title="statement not covered" >        break;</span>
      case 'delete':
<span class="cstat-no" title="statement not covered" >        postMiddleware = options.postDelete;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    async.eachSeries(postMiddleware, <span class="fstat-no" title="function not covered" >function (middleware, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >      middleware(req, res, cb);</span>
    }, <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        return errorHandler(req, res, next)(err);</span>
      }
&nbsp;
      // TODO: this will, but should not, filter /count queries
<span class="cstat-no" title="statement not covered" >      if (req.erm.result) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        req.erm.result = options.filter ? options.filter.filterObject(req.erm.result, opts) : req.erm.result;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (options.totalCountHeader &amp;&amp; req.erm.totalCount) {</span>
<span class="cstat-no" title="statement not covered" >        res.header(_.isString(options.totalCountHeader) ? options.totalCountHeader : 'X-Total-Count', req.erm.totalCount);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      options.outputFn(req, res);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (options.postProcess) {</span>
<span class="cstat-no" title="statement not covered" >        options.postProcess(req, res, next);</span>
      }
    });
  };
};
