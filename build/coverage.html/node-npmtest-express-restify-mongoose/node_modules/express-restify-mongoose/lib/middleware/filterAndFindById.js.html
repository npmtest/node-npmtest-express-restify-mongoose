...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/filterAndFindById.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/filterAndFindById.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-restify-mongoose/node_modules/express-restify-mongoose/lib/middleware/</a> &#187; filterAndFindById.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      filteredContext.findOne().and(_defineProperty({}, options.idProperty, req.params.id)).lean(false).read(options.readPreference).exec().then(<span class="fstat-no" title="function not covered" >function (doc) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        req.erm.document = doc;</span>
&nbsp;
